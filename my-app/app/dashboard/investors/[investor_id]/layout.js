...
export default function InvestorDetailLayout({ children, params }) {
  ...
  const tabs = [
    { label: "Overview", href: `/dashboard/investors/${investor_id}` },
    { label: "Holdings", href: `/dashboard/investors/${investor_id}/holdings` },
    { label: "Net Worth", href: `/dashboard/investors/${investor_id}/networth` },
  ];
